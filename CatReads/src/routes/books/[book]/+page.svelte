...
<div class="h-full w-[100vw] bg-white flex">
    <div class="bg-red-200 w-1/2 flex items-end border-r-2 border-red-500">
        <img src={book.PhotoString} alt={book.Name + ' book cover'} class="w-full">
        <div class="fixed bg-gradient-to-b from-black/0 to-black/100 h-1/3 w-1/2 text-white flex items-center justify-center font-sans">
    ...
    <div class="w-1/2 h-full flex flex-col border-l-2 border-red-500">
        <div class="h-[10%]"></div>

        <div class="w-full h-3/5 p-5 gap-2.5 items-center justify-center flex border-b-2 border-red-500">
        ...
        <div class="w-full h-1/2 border-t-2 border-red-500 overflow-y-auto">
